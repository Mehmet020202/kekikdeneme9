...
class Dizilla : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        "${mainUrl}/tum-bolumler" to "🔥 EN SON BÖLÜMLER",
        "${mainUrl}/arsiv" to "🔥 EN SON DİZİLER",
        "${mainUrl}/populer-diziler" to "🔥 POPÜLER DİZİLER", 
        "${mainUrl}/en-iyi-diziler" to "🔥 EN İYİ DİZİLER",
